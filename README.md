<p align="center">
    ...
    <br />
    <a href="https://github.com/DevelopersToolbox/bash-script-template/actions/workflows/pipeline.yml">
...
1. Clone the repository (git clone https://github.com/DevelopersToolbox/bash-script-template)
2. Edit the script (vi src/bash-script-template.sh)
3. Edit process_arguments/usage to reflect your cli requirements
